...
name: self-update
description: >
  Automatically check for new Codex skills, MCP servers, tools and tutorials
  from GitHub trending, community repos, and other sources. Keeps the setup current.
---

# Self-Update

定期扫描优质资源渠道，发现新的 Codex skills、MCP 服务器、学习资料和开发工具，并更新本地配置。
...
| [mattpocock/skills](https://github.com/mattpocock/skills) | 新 Codex skills | 每周 |
| [anthropics/knowledge-work-plugins](https://github.com/anthropics/knowledge-work-plugins) | Codex 官方插件 | 每周 |
...
1. 列出 `~/.Codex/skills/` 和 `~/Projects/study_plan/.Codex/skills/` 中已有的 skills
