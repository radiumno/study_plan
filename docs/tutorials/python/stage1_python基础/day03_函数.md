---
title: Day 3 | 函数 -- 把代码封装成可复用的模块
description: 课程源码镜像页，由 scripts/sync_docs.py 生成
---

# Day 3 | 函数 -- 把代码封装成可复用的模块

> 来源文件: `projects/python/stage1_python基础/day03_函数.py`
...
#
# ════════════════════════════════════════════════════
#  想深入理解函数式编程? 翻 _ai_ref Phase 1 的
#  相关数学概念(函数映射/变换), 跑一遍 code/
#  _ai_ref/phases/01-math-foundations/<lesson>/code/
# ════════════════════════════════════════════════════
